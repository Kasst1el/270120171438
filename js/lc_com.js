$(function(){
		...
		$(".lc_main .wrap_gallery").swipe({
			tap:function(){
				...
				if(stock_count == maxLenght){
					stock_count = 0;
					$( ".lc_main .promocods .gallery_less_580 .wrap_gallery h2").text("17%");
					$( ".lc_main .promocods .gallery_less_580 .wrap_gallery h3").text("Промокод №1");
				} if(stock_count == 2){
					//stock_count = 0;
					$( ".lc_main .promocods .gallery_less_580 .wrap_gallery h2").text("12%");
					$( ".lc_main .promocods .gallery_less_580 .wrap_gallery h3").text("Промокод №3");
				} 
				if(stock_count == 1){
					//stock_count = 0;
					$( ".lc_main .promocods .gallery_less_580 .wrap_gallery h2").text("15%");
	...
	function user(){
		...
		//$("#piggy-bank_content::after").fadeOut(0);
	...
	function piggyBank(){
		...
		//$("#piggy-bank_content::after").fadeIn(400);
	...
	function promocods(){
		...
		$(".sale").fadeOut(0);
		$(".referal_system").fadeOut(0);
		var x = $(".gallery_less_580 .wrap_gallery div").length;
		for(var i = 1; i <= x; i++ ){
